...
verificarSesion();
verificarPermisoModulo("empleado_conceptos.php");
...
<head>
    <meta charset="UTF-8">
    <title>Nueva Asignación de Concepto</title>
...
<div class="contenedor">
    <h2>Nueva Asignación de Concepto</h2>

    <form action="empleado_concepto_guardar.php" method="POST">
        ...
        <div class="grupo">
            ...
            <input type="number" step="0.01" name="monto_manual" id="monto_manual" value="0.00">
        </div>

        <div class="grupo">
            <label for="porcentaje_manual">Porcentaje Manual</label>
            <input type="number" step="0.01" name="porcentaje_manual" id="porcentaje_manual" value="0.00">
        </div>

        <div class="grupo">
            <label for="cantidad">Cantidad</label>
            <input type="number" step="0.01" name="cantidad" id="cantidad" value="1.00">
        </div>
